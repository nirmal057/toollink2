...
const Order = require('./ToolinkBackend/src/models/Order');
const SubOrder = require('./ToolinkBackend/src/models/SubOrder');
const Material = require('./ToolinkBackend/src/models/Material');
const Warehouse = require('./ToolinkBackend/src/models/Warehouse');
const User = require('./ToolinkBackend/src/models/User');

// MongoDB connection string - replace with your actual connection string
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://tooLink:Lahiru%401234@toolink.oek28.mongodb.net/ToolLink?retryWrites=true&w=majority&appName=ToolLink';
